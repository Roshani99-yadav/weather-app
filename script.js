//function to change the icon accordin to the weather description
function getIconClass(classarg) {
    if (classarg === 'Rain') {
        ...
        return 'fas fa-thunderstrom';
    } else {
        return 'fas fa-cloud-sun';
    }
}
//function to change the background according to the weather descriptipon.
...
function changeBg(status) {
    if (status === 'Clouds') {
        ...
        document.body.style.backgroundImage = 'url(./Image/clear.gif)';
    } else if (status === 'Snow') {
        document.body.style.backgroundImage = 'url(./Image/snow.gif)';
    } else if (status === 'Sunny') {
        document.body.style.backgroundImage = 'url(./Image/sunny.gif)';
    } else if (status === 'Thunderstorm') {
        document.body.style.backgroundImage = 'url(./Image/thunderstrom.gif)';
    } else if (status === 'Drizzle') {
        document.body.style.backgroundImage = 'url(./Image/drizzle.gif)';
    } else if (status === 'Mist' || status === 'Haze' || status === 'Fog') {
        document.body.style.backgroundImage = 'url(mist.gif)';
    } else {
        document.body.style.backgrondImage = 'url(background.jpg)';
    }
